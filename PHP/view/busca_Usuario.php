    ...
    <main>
        <div class="global-container">
            <div class="card login-form">
                ...
                <div class="card-text">
                    <form action="./exibir_Usuario.php" method="POST">
                        ...
                        <div class="m-auto text-center">
                            ...
                            <div class="form-check form-check-inline mb-1">
                                <input class="form-check-input" type="radio" name="rbtBusca" id="chkNome" value="nome">
                                <label class="form-check-label" for="chkNome">Nome</label>
                            </div>

                            <div class="form-check form-check-inline mb-1">
                                <input class="form-check-input" type="radio" name="rbtBusca" id="chkEmail" value="email">
                                <label class="form-check-label" for="chkEmail">Email</label>
                            </div>

                            <div class="form-check form-check-inline mb-1">
                                <input class="form-check-input" type="radio" name="rbtBusca" id="chkCpf" value="cpf">
                                <label class="form-check-label" for="chkCpf">CPF</label>
                            </div>

                            <div style="opacity: 0; display:none;">
                                <input class="form-check-input" type="radio" name="rbtBusca" id="chkNome" value="vazio" checked>
                            </div>
